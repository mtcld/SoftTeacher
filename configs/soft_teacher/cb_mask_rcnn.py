...
data = dict(
    ...
    train=dict(
        ...
        unsup=dict(
            type="CocoDataset",
            ann_file=data_root+"../merimen_coco/12_10/dent/annotations/total.json",
...
epoch_length_after_batch = 2500

evaluation = dict(type="SubModulesDistEvalHook", interval=epoch_length_after_batch, metric=["bbox", "segm"])
...
lr_config = dict(step=[epoch_length_after_batch*15, epoch_length_after_batch*18])
runner = dict(_delete_=True, type="IterBasedRunner", max_iters=epoch_length_after_batch*25)
checkpoint_config = dict(by_epoch=False, interval=epoch_length_after_batch, max_keep_ckpts=20)

fp16 = dict(loss_scale="dynamic")
load_from = 'pretrain/mask_rcnn_cbv2_swin_tiny_patch4_window7_mstrain_480-800_adamw_3x_coco.pth'
fold = 1
percent = 1
work_dir = './work_dirs/dent_cbm'
log_config = dict(
    interval=50,
    hooks=[
