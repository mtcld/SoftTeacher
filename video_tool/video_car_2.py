...
def main():
    ...
    for file in video_files:
        ...
        print('debug frame size : ',frame_w,frame_h)
        ...
        scracth_cross_check = Cross_check_pair(hungarian)
        print('cross check ...',name)
        ...
        final_result = collect_final_result_after_cross_check(damaged_by_frame)
        print(final_result)
