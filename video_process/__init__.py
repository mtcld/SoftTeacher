...
def init_yolo_models():
    ...
    dent_yolo= Yolo(file_name='checkpoint/dent.pth',confident=0.3,iou_thres=0.5,device='2',imgsz_list=[1536])
    # missing_yolo= Yolo(file_name='missing.pt',confident=0.5,iou_thres=0.5,device='0',imgsz_list=[1443])

    # return {'crack':crack_yolo,'scratch':scratch_yolo,'dent':dent_yolo,'missing':missing_yolo}
